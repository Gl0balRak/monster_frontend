      ...
      <div className="w-full">
        <div className="bg-white rounded-lg p-6 space-y-6">
          ...
          <div className="overflow-hidden">
            <ToolDescription
              shortDescription="Парсинг ключевых слов и анализ топовых конкурентов"
              fullDescription={
                <div className="space-y-3">
                  <p>
                    <strong>Индекс запросов</strong> — это инструмент для глубокого анализа 
                    ключевых слов и выявления топовых конкурентов в поисковой выдаче.
                  </p>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      ...
                      <li>Спрос и конкурентность запросов</li>
                      <li>Топовые страницы конкурентов</li>
                      <li>Семантическое ядро по заданным фразам</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      ...
                      <li>Выявить сильных конкурентов в нише</li>
                      <li>Проанализировать спрос на различные запросы</li>
                      <li>Найти новые возможности для продвижения</li>
                    </ul>
                  </div>
                </div>
              }
          ...
          <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200">
                ...
                >
                  {isLoading ? "Выполняется парсинг..." : "Запустить парсинг (10 л.)"}
                </Button>
