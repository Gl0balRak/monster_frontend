        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <Textarea
                placeholder="купить телефон, смартфон, ц��на мобильный телефон, планшет, ноутбук"
                value={manualQueries}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
            <Select
              ...
              options={[
                ...
                {
                  value: "phrase_en",
                  label: "Фраза и английский а��фавит [a-z]",
                },
        ...
        <div className="bg-white rounded-lg p-6">
          ...
          <div className="mb-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
              ...
              />
              <Checkbox
                label="Латиница (удал��ет фразы с латиницей)"
