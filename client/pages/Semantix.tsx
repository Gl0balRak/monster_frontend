...
const Semantix: React.FC = () => {
  ...
  const handleScroll = () => {
    ...
    if (actionsPanel) {
      ...
      if (rect.top <= 72) {
        setIsActionsSticky(true);
      } else {
        setIsActionsSticky(false);
      }
    }
  };
      ...
      <div className="w-full">
        <div className="bg-white rounded-lg p-6 space-y-6">
          ...
          <div className="overflow-hidden">
            <ToolDescription
              shortDescription="Сбор и анализ семантического ядра для SEO-оптимизации"
              fullDescription={
                <div className="space-y-3">
                  <p>
                    <strong>Семантикс</strong> — это мощный инструмент для сбора, анализа и кластеризации
                    семантического ядра вашего сайта и конкурентов.
                  </p>

                  <div>
                    <strong>Что анализирует инструмент:</strong>
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      <li>Ключевые слова и их частотность</li>
                      <li>Поисковые подсказки и LSI-фразы</li>
                      <li>Спрос и кликабельность запросов</li>
                      <li>Конкурентность и коммерциализацию</li>
                      <li>Тематическую кластеризацию запросов</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside mt-1 space-y-1">
                      <li>Составить полное семантическое ядро</li>
                      <li>Найти новые ключевые фразы и ниши</li>
                      <li>Оптимизировать структуру сайта</li>
                      <li>Улучшить позиции в поисковой выдаче</li>
                      <li>Создать релевантный контент</li>
                    </ul>
                  </div>
                </div>
              }
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            <h2 className="text-lg font-bold text-black font-['Open_Sans',-apple-system,Roboto,Helvetica,sans-serif] mb-6">
              Настройки парсинга
            </h2>
          ...
          <div className="overflow-hidden mb-6">
                <ToolDescription
                  shortDescription="Сбор, анализ и кластеризация поисковых запросов с выгрузкой в Excel."
                  fullDescription={
                    <div className="space-y-3">
                      <p>
                        Этот инструмент упрощает процесс сбора семантического ядра, позволяя собирать, фильтровать, анализировать и выгружать ключевые запросы и связанные с ними показатели из различных источников.
                      </p>

                      <div>
                        <strong>Основные этапы работы:</strong>
                        <ul className="list-disc list-inside mt-1 space-y-1">
                          <li><strong>Сбор запросов</strong><br/>
                          Доступны два способа: автоматический парсинг (указание сайта/конкурентов, выбор региона и сервисов, запуск сбора) и ручное добавление (вставка или загрузка списка фраз из файла).</li>

                          <li><strong>Чистка запросов</strong><br/>
                          В специальной вкладке можно убрать запросы дубли, или содержащие цифры, латинские буквы, однословные ключи, стоп-слова, а также автоматически гибко исключать запросы с названиями городов, настроив список исключений.</li>

                          <li><strong>Сбор данных по запросам</strong><br/>
                          Для выбранных фраз можно получить поисковые подсказки, данные о спросе, кликах, конкурентности, коммерциализации. Все действия происходят через соответствующие кнопки действий и применяются к выбранное группе запросов.</li>

                          <li><strong>Кластеризация</strong><br/>
                          Можно сгруппировать запросы по смыслу (кластеризация).</li>

                          <li><strong>Выгрузка результатов</strong><br/>
                          Результаты экспортируются в таблицу Excel.</li>
                        </ul>
                      </div>
                    </div>
                  }
              ...
              <div className="space-y-3">
                ...
                {competitors.length < 10 && (
                  <button
                    ...
                    className="text-red-600 font-normal text-base hover:text-red-700"
                  >
                    + Добавить конкурента
                  </button>
                )}
              ...
              <div className="flex flex-wrap gap-6">
                ...
                <div className="flex items-center">
                  <a
                    ...
                    className="text-red-600 font-normal text-base hover:text-red-700 hover:underline transition-colors"
                  >
                    Ahrefs
                  </a>
                </div>
          ...
          <div className="bg-white rounded-lg p-6 border border-gray-200">
            <h2 className="text-lg font-bold text-black font-['Open_Sans',-apple-system,Roboto,Helvetica,sans-serif] mb-4">
              Управление таблицей
            </h2>

            <div className="space-y-4 mb-6">
              {/* Первый ряд: поиск и основные кнопки */}
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6 border">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-semibold text-gray-900">Позиция</label>
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-semibold text-gray-900">W</label>
                    <div className="flex gap-2">
                      <Input
                        placeholder="От"
                        value={filters.wFrom}
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-semibold text-gray-900">Спрос</label>
                    <div className="flex gap-2">
                      <Input
                        placeholder="От"
                  ...
                  <div className="space-y-2">
                    <label className="text-base font-semibold text-gray-900">Клики</label>
                    <div className="flex gap-2">
                      <Input
                        placeholder="От"
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center justify-center min-w-[60px] px-3 py-2 text-sm text-gray-700 bg-gray-100 rounded">
