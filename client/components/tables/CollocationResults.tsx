...
export const CollocationResults: React.FC<CollocationResultsProps> = ({
  data,
  loading = false,
  onBack
}) => {
  ...
  const [showContexts, setShowContexts] = useState<boolean>(true); // По умолчанию показываем контексты
  const [expandedContexts, setExpandedContexts] = useState<Set<string>>(new Set()); // Для разворачивания контекстов
                                  ...
                                  <tr className="border-b hover:bg-gray-50">
                                    <td className="py-2 px-4">
                                      <div className="flex items-center gap-2">
                                        ...
                                        {hasContexts && (
                                          <button
                                            onClick={() => toggleContexts(contextKey)}
